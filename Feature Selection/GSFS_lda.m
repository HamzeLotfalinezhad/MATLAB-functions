function [BestF all_BACC all_BestF Results2]=GSFS_lda(Feature_Matrix,Wanted_F,...
    Combination,ClassNum,K_Fold,DiscrimType,BestFComb,P,itr)
...
[Accuracy, Results]=LQDA_GridSearch(Feature_Matrix(:,SeFe(c,:)),ClassNum,K_Fold,'2',DiscrimType,10,itr);
