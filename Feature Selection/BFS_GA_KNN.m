function [Feat_Index Accuracy Sensitivity Specificity ConfM1 Kappa ]=  BFS_GA_KNN(FM,ClassNum,...
    Kfold,NumNeighbor,POPsize,Generation)
...
FM1 = Data;
FM2 = FM1(:,[FeatIndex]);
[Accuracy Sensitivity Specificity ConfM1 Kappa]=KNN_Kfold(FM2,ClassN,K_fold,NumN);
FitVal=100-Accuracy;
global CM0
global Accuracy0
global Sensitivity0
