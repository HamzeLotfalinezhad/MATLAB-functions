function [all_BACC all_BestF COM2]=GLFRB_nbc(FM,LR,Wanted_F,ClassNum,K_Fold)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% SFS 
[BestF_F all_BACC_F all_BestF_F COM_F]=GSFS_nbc(FM_F,WF_F,Comb_F,...
    ClassNum,K_Fold,BestFComb_F,0);
...
BestFComb_B=BestF_F;
[BestF_B all_BACC_B all_BestF_B COM_B]=GSBS_nbc(FM,WF_B,Comb_B,...
    ClassNum,K_Fold,BestFComb_B,0);
