function [Feat_Index Accuracy Sensitivity Specificity ConfM1 Kappa ]=  BFS_GA_DTree(FM,ClassNum,...
...
FM1 = Data;
FM2 = FM1(:,[FeatIndex]);
[Accuracy Sensitivity Specificity ConfM1 Kappa]=DTree_Kfold(FM2,ClassN,K_fold);
FitVal=100-Accuracy;
global CM0
global Accuracy0
global Sensitivity0
