function [BestF all_BACC all_BestF COM2]=GSFS_svm(Feature_Matrix,Wanted_F,Combination,ClassNum,K_Fold,Kernel_F,Kernel_P,BestFComb,P)
...
[Accuracy,~,~,COM] = SVM_Kfold(Feature_Matrix(:,SeFe(c,:)),ClassNum,K_Fold,Kernel_F,Kernel_P);        
