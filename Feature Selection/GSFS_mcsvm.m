function [BestF all_BACC all_BestF COM2]=GSFS_mcsvm(Feature_Matrix,Wanted_F,Combination,ClassNum,K_Fold,Kernel_F,Kernel_P,BestFComb,P,SvmType)
...
switch SvmType
    case 'ovo'
  [Accuracy , ~, ~, COM] = MCSVM_OVO_KFold(Feature_Matrix(:,SeFe(c,:)),ClassNum,K_Fold,Kernel_F,Kernel_P);
    case 'ova'
  [Accuracy , ~, ~, COM] = MCSVM_OVA_KFold(Feature_Matrix(:,SeFe(c,:)),ClassNum,K_Fold,Kernel_F,Kernel_P);
