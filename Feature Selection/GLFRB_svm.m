function [all_BACC all_BestF COM2]=GLFRB_svm(FM,LR,Wanted_F,ClassNum,K_Fold,Kernel_F,Kernel_P)
...
[BestF_F all_BACC_F all_BestF_F COM_F]=GSFS_svm(FM_F,WF_F,Comb_F,...
    ClassNum,K_Fold,Kernel_F,Kernel_P,BestFComb_F,0);
...
[BestF_B all_BACC_B all_BestF_B COM_B]=GSBS_svm(FM,WF_B,Comb_B,...
    ClassNum,K_Fold,Kernel_F,Kernel_P,BestFComb_B,0);
