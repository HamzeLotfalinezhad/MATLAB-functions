function [Accuracy Sensitivity Specificity ConfM1 Kappa]=NBC_Kfold(FM0,ClassNum,K_Fold)
...
% ******************** NBAYSIAN
NBC=NaiveBayes.fit(Train2,TrainTarget_uc);
Predicted_Class=NBC.predict(Test2);    % Outputs
