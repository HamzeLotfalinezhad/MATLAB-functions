function [Accuracy Sensitivity Specificity ConfM1 Kappa]= MLP_Kfold(FM0,ClassNum,K_Fold,Num_Layer,Neuron)
...
[TrainC TestC]=ClassCoding(TrainTarget_uc,TestTarget_uc,ClassNum);
%% |||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||   Training Classifiers |||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
% ******************** MLP
Layer_AF={'tansig'};
Layer=repmat(Layer_AF,1,Num_Layer);
Network = newff(Train2',TrainC',Neuron,Layer);
Network.trainParam.showWindow = false;
Network= train(Network,Train2',TrainC');
% Test
% |||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||| train results
