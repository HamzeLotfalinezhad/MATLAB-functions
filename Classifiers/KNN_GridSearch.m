function [Accuracy, Results]=KNN_GridSearch(FM,ClassNum,KFold,Optimize,Num_Grid,Iteration)
...
trainedClassifier = fitcknn(X,Y,'Standardize',1,...
    'ObservationsIn','rows',...
...
elseif Optimize=='3'
Results.BestResults=sortrows(trainedClassifier.HyperparameterOptimizationResults,7);
end
