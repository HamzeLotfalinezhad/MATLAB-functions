function [Accuracy, Results]=SVM_MultiClass(FM,ClassNum,KFold,Method,KernelFunction,C,S)
...
switch Method
    case 'onevsone' %OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
...
%_______________________________________________________________________________
 ...
 %___________________________________________________________________________________       
    ...
    case 'onevsall' %OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
        switch KernelFunction
%___________________________________________________________________________________
            case 'linear'
                if isempty(S)==1;S='auto';end
...
trainedClassifier = fitcecoc(X,Y, 'Learners', template, 'Coding', Method); % trainSVM no optimiza
